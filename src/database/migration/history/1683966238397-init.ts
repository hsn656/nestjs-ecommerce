...
export class Init1683966238397 implements MigrationInterface {
  name = 'Init1683966238397';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "product" ("id" SERIAL NOT NULL, "code" character varying NOT NULL, "title" character varying NOT NULL, "variationType" character varying NOT NULL, "description" text, "about" text array NOT NULL DEFAULT '{}', "details" jsonb, "isActive" boolean NOT NULL DEFAULT false, "merchantId" integer, "categoryId" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "product_variation" ("id" SERIAL NOT NULL, "productId" integer NOT NULL, "sizeCode" character varying(7) NOT NULL, "colorName" character varying(30) NOT NULL, "imageUrls" text array NOT NULL DEFAULT '{}', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_bfae10232dcbc2c77fb37d0ebf5" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "inventory" ("id" SERIAL NOT NULL, "productVariationId" integer NOT NULL, "countryCode" character varying(7) NOT NULL, "quantity" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_82aa5da437c5bbfb80703b08309" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "product_variation_price" ("id" SERIAL NOT NULL, "productVariationId" integer NOT NULL, "countryCode" character varying(7) NOT NULL, "currencyCode" character varying(7) NOT NULL, "price" double precision NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_3b3ac8ce948a3f88a0c8c1fb4f6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product_variation" ADD CONSTRAINT "FK_9eb6ebb27c4efb410d7a89670b5" FOREIGN KEY ("productId") REFERENCES "product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_variation" ADD CONSTRAINT "FK_320442ee533dc6dbcaf28f4c58e" FOREIGN KEY ("sizeCode") REFERENCES "size"("code") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_variation" ADD CONSTRAINT "FK_78161b50cf9e0db3b14962b4dd9" FOREIGN KEY ("colorName") REFERENCES "color"("name") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product_variation_price" ADD CONSTRAINT "FK_b519d6fa0ef2e0e8b73ac473edb" FOREIGN KEY ("productVariationId") REFERENCES "product_variation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_variation_price" ADD CONSTRAINT "FK_8a44e4e97706b95305450b92716" FOREIGN KEY ("countryCode") REFERENCES "country"("code") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_variation_price" ADD CONSTRAINT "FK_ecdc419b741a8e31986e4aed94b" FOREIGN KEY ("currencyCode") REFERENCES "currency"("code") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "product_variation_price" DROP CONSTRAINT "FK_ecdc419b741a8e31986e4aed94b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_variation_price" DROP CONSTRAINT "FK_8a44e4e97706b95305450b92716"`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_variation_price" DROP CONSTRAINT "FK_b519d6fa0ef2e0e8b73ac473edb"`,
    );
    await queryRunner.query(
      `ALTER TABLE "inventory" DROP CONSTRAINT "FK_8c027794f89b1607ccbba284ec5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "inventory" DROP CONSTRAINT "FK_61f77b98a38ff29f0fa5fb9d679"`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_variation" DROP CONSTRAINT "FK_78161b50cf9e0db3b14962b4dd9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_variation" DROP CONSTRAINT "FK_320442ee533dc6dbcaf28f4c58e"`,
    );
    await queryRunner.query(
